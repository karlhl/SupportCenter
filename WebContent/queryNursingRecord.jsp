...
<nav class="navbar navbar-default">
	...
	<form name="myform" action="http://localhost:8080/SupportCenter/NursingQueryController" method="get">
		<input type="text" name="CUSTOMER_ID" id="CUSTOMER_ID" placeholder="请输入客户ID">
	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td>${s.NURSING_ID}</td>
			<td><a href="/SupportCenter/NursingQueryController?id=${s.CUSTOMER_ID}&flag=update">更新</a> <a href="javascript:checkdelete('/SupportCenter/ContentDelectController?cid=${s.id}')" >删除</a></td>
		</tr>
		</c:forEach>
	</table>
