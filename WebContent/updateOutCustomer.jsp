...
<html>
	...
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
		...
		<!-- /.container-fluid -->
            ...
            <form name = "myform" action="/SupportCenter/UpdateOutCustomer" method="get">
				<!--表单元素-->
				<!--input type="text" name = "wd"/>
				<input type="submit" value="百度一下" />-->
				ID:<input type="text" name = "ID" id = "ID" value="${requestScope.outCustomers[0].ID}" readonly /><br/>
				客户ID:<input type="text" name = "customerID" value="${requestScope.outCustomers[0].customerID}" readonly /><br/>
				外出时间:<input type="date"name="outgoingTime" value="${requestScope.outCustomers[0].outgoingTime}"/><br />
				外出原因:<input type="text"name="outgoingReason" value="${requestScope.outCustomers[0].outgoingReason}"/><br />
				预计回来时间:<input type="date"name=expectedReturnTime value="${requestScope.outCustomers[0].expectedReturnTime}"/><br />
				实际回来时间:<input type="date"name=actualReturnTime value="${requestScope.outCustomers[0].actualReturnTime}"/><br />
			           配同人员:<input type="text"name="escorted" value="${requestScope.outCustomers[0].escorted}"/><br />
			           配同人员与老人关系:<input type="text"name="relation" value="${requestScope.outCustomers[0].relation}"/><br />       
				 配同人员联系方式:<input type="text"name="escortedTel" value="${requestScope.outCustomers[0].escortedTel}"/><br/>
