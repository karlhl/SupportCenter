...
<html>
	...
	<nav class="navbar navbar-default">
	 ...
	 <h1 class="color">退宿申请查询页面（若已提交退宿申请，查不到对应信息）</h1>
		<form name="myform" action="/SupportCenter/queryCustomer2Controller?" method="get">
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td>${s.age}</td>
				<td>${s.sex}</td>
				<td><a href="/SupportCenter/queryCustomerByIDController2?ID=${s.ID}">退宿</a></td>
			</tr>
			</c:forEach>
		</table>
	</body>
