...
<html>
	...
	<nav class="navbar navbar-default">
		...
		<form name="myform" action="/SupportCenter/QueryOutCustomer?" method="get">
		...
		<table class="table table-striped">
			...
			<c:forEach items = "${requestScope.outCustomers}" var="s">
			<tr>
				<td>${s.ID}</td>
				<td>${s.customerID}</td>
				<td>${s.outgoingReason}</td>
				<td>${s.outgoingTime}</td>
				<td>${s.expectedReturnTime}</td>
				<td>${s.actualReturnTime}</td>
				<td>${s.escorted}</td>
				<td>${s.relation}</td>
				<td>${s.escortedTel}</td>
				<td><a href="/SupportCenter/QueryOutCustomerByID?ID=${s.ID}"> 更新</a> <a href="javascript:checkDelete('/SupportCenter/DeleteOutCustomer?ID=${s.ID}')">删除</a></td>
			</tr>
			</c:forEach>
		</table>
	</body>
