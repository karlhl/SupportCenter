...
<html>
	...
	<nav class="navbar navbar-default">
	 ...
	 <h1 class="color">外出申请查询页面</h1>
		<form name="myform" action="/SupportCenter/QueryCustomerControllerForOut?" method="get">
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td>${s.age}</td>
				<td>${s.sex}</td>
				<td><a href="/SupportCenter/queryCustomerByIDController2?ID=${s.ID}&flag=out">申请外出</a></td>
			</tr>
			</c:forEach>
		</table>
	</body>
