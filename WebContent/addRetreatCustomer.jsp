...
<html>
	...
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
		...
		<!-- /.container-fluid -->
            ...
            <h1 class="color">退宿申请页面</h1>
            <!--表单标签-->
			<div style="color: #FF0000; font-size: 36px; font-weight: bold;" id="errorMessage">${requestScope.msg}</div>
            <form name = "myform" action="/SupportCenter/AddRetreatCustomer" method="get">
				<!--表单元素-->
				<!--input type="text" name = "wd"/>
				<input type="submit" value="百度一下" />-->
				客户ID:<input type="text" name = "customerID" id = "CustomerID" value="${requestScope.customer[0].ID}" readonly /><br/>
				退宿时间:<input type="date"name="retreatTime" /><br />
				退宿原因:<input type="text"name="reason" /><br />
				备注:<input type="text"name="describe" /><br />
				申请时间:<input type="date"name="askTime" /><br/>
